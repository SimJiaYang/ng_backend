...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h5 class="card-header">Product Stock History</h5>
                <div class="card m-3">
                    @foreach ($product as $products)
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <p class="fw-normal mb-1">Current Inventory: &nbsp;</p>
                                <p class="fw-bold mb-1">{{ $products->quantity }} Item</p>
                            </div>
                            <div class="d-flex align-items-center">
                                <p class="fw-normal mb-1">Last updated at:: {{ $products->updated_at }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
